...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Manage Hospitals</h2>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($hospital->logo)
                                <img src="{{ $hospital->logo }}" alt="{{ $hospital->name }}" class="h-12 w-auto object-contain">
                            @else
                        ...
                        <td class="px-6 py-4">
                            ...
                            @if($hospital->description)
                                <div class="text-sm text-gray-500 truncate max-w-xs">{{ Str::limit($hospital->description, 50) }}</div>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            No hospitals found. <a href="{{ route('admin.hospitals.create') }}" class="text-[#0a4d78] hover:underline">Create one now</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
