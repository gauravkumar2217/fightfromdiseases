                            ...
                            <div class="space-y-6 mb-8">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:info@fightfromdiseases.com" class="text-gray-600 hover:text-[#0a4d78] transition-colors">
                                            info@fightfromdiseases.com
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+15551234567" class="text-gray-600 hover:text-[#0a4d78] transition-colors">
                                            +1 (555) 123-4567
                                        </a>
                                    </div>
                                </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-gray-200 rounded-2xl overflow-hidden shadow-xl h-96 flex items-center justify-center">
